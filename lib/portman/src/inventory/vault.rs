...
/// by name: `portman_private_keys[inventory_hostname]`.
pub const PRIVATE_KEYS_VAR: &str = "portman_private_keys";

/// portman shells out to ansible-vault rather than implementing the
